...
const Navbar = ({ userRole, onLogout, language, onLanguageToggle }) => {
  ...
  const translatedLabel = language === 'ta' ? 
    (isDoctor ? 'மருத்துவர்' : 'பராமரிப்பாளர்') : roleLabel;
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center gap-6">
            ...
            >
              <LogOut size={18} /> {language === 'en' ? 'Logout' : 'வெளியேறு'}
            </button>
          </div>
...
const LandingPage = ({ onSelectRole, language }) => {
  const content = {
    en: {
      title: 'Memory Lane',
    ...
    ta: {
      title: 'மெமரி லேன்',
      subtitle: 'AI-அடிப்படையிலான மெமரி லேன் சிस்டம்',
      tagline: 'மருத்துவர்கள் மற்றும் பராமரிப்பாளர்களை நினைவாற்றல் சிகிச்சைக்காக இணைக்கும்',
      features: [
        { icon: Brain, title: 'காயம்-அடிப்படையிலான ব்যক்তிগতকরण', desc: 'அடிதழுவு, TBI மற்றும் தலை காயங்களுக்கான தனிப்படுத்தப்பட்ட சிகிச்சை' },
        { icon: Zap, title: 'AI-உருவாக்கப்பட்ட சிகிச்சை', desc: 'நோயী தேவைக்கு ஏற்ப மாற்றப்பட்ட சிகிச்சை திட்டங்கள்' },
        { icon: Activity, title: 'நோயী கண்காணிப்பு', desc: 'நிகழ்நேரத்தில் முன்னேற்றம் கண்காணிப்பு மற்றும் சுகாதாரம் பற்றிய தகவல்' },
      ],
      doctorBtn: 'மருத்துவராக உள்நுழைக',
      caregiverBtn: 'பராமரிப்பாளராக உள்நுழைக',
      learnMore: 'அது எப்படி வேலை செய்கிறது',
    }
  };
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-purple-50">
      ...
      <div className="mt-20 py-8 border-t border-gray-200 text-center text-gray-600 text-sm">
        <p>© 2024 Memory Lane - Intelligent Healthcare Solutions. All rights reserved.</p>
      </div>
    </div>
  );
};
...
const LoginPage = ({ role, onLogin, onBack, language }) => {
  ...
  const content = {
    ...
    ta: {
      doctor: { title: 'மருத்துவர் உள்நுழைவு', subtitle: 'நோயி நிர்வாகம் மற்றும் கண்காணிப்பு அணுகவும்' },
      caregiver: { title: 'பராமரிப்பாளர் உள்நுழைவு', subtitle: 'நோயி பராமரிப்பு மற்றும் சிகிச்சை அமர்வுகளை நிர்வகிக்கவும்' },
      email: 'மின்னஞ்சல் முகவரி',
      password: 'கடவுச்சொல்',
      login: 'உள்நுழைக',
      demo: 'டெமோ கணக்கை பயன்படுத்தவும்',
      ...
      <div className="w-full max-w-md">
        ...
        <p className="text-center text-xs text-gray-600 mt-6">
          {language === 'en' 
            ...
            : 'கணினி பரীक்ষணத்திற்கான டெமோ கணக்குகள் கிடைக்கின்றன'}
        </p>
      </div>
    </div>
  );
...
const DoctorDashboard = ({ user, language }) => {
  ...
  const content = {
    ...
    ta: {
      ...
      patients: 'உங்கள் நோயிகள்',
      viewDetails: 'விவரங்களைக் காணுக',
      patientId: 'ID',
      patientAge: 'வயது',
      injuryType: 'காயத்தின் வகை',
      status: 'நிலை',
      medical: 'மருத்துவ வரலாறு',
      therapy: 'சிகிச்சை திட்டம்',
      progress: 'முன்னேற்றம்',
      insights: 'AI பற்றிய தகவல்',
      reports: 'அறிக்கைகளைக் காணுக',
      alerts: 'எச்சரிக்கைகள்',
      memoryImprov: 'நினைவாற்றல் மேம்பாடு',
      taskCompletion: 'பணி முடிப்பு',
      criticalAlerts: 'முக்கியமான எச்சரிக்கைகள்',
      noAlerts: 'முக்கியமான எச்சரிக்கைகள் இல்லை',
      riskLevel: 'ஆபத்து நிலை',
      recommendations: 'பரிந்துரைகள்',
      therapyAdherence: 'சிகிச்சை கடமை',
      sessions: 'முடிந்த அமர்வுகள்',
      back: 'பட்டியலுக்குத் திரும்பவும்',
    }
  };
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <Navbar userRole="doctor" language={language} />
...
const CaregiverDashboard = ({ user, language }) => {
  ...
  const content = {
    ...
    ta: {
      ...
      selectInjury: 'காயத்தின் வகை தேர்ந்தெடுக்கவும்',
      symptoms: 'கவனிக்கப்பட்ட அறிகுறிகள்',
      forgetfulness: 'மறதி',
      confusion: 'குழப்பம்',
      moodChanges: 'மனநிலை மாற்றங்கள்',
      headache: 'தலைவலி',
      concentration: 'கவனம் செலுத்த சிரமம்',
      sleep: 'தூக்க சிக்கல்',
      irritability: 'எரிச்சல்',
      generateTherapy: 'AI சிகிச்சை திட்டம் உருவாக்கவும்',
      therapySteps: 'இன்றைய சிகிச்சை படிகள்',
      completedToday: 'இன்று முடிந்தது',
      dailyChecklist: 'தினசரி செய்ய வேண்டிய பணிகள்',
      voiceAssistant: 'குரல் உதவி',
      step: 'படி',
      complete: 'முடிந்ததாக குறிக்கவும்',
      next: 'அடுத்த படி',
      prev: 'முந்தைய',
      allComplete: 'அனைத்து பயிற்சிகளும் முடிந்துவிட்டது!',
      medication: 'மருந்தை எடுக்கவும்',
      breakfast: 'காலை உணவு சாப்பிடுங்கள்',
      morningWalk: 'காலை நடைப்பயணம் (20 நிமிடம்)',
      familyTime: 'குடும்ப நேரம்',
      evening: 'மாலை நடவடிக்கைகள்',
      sleep: 'தூக்க அட்டவணை',
      sessionStart: 'அமர்வு தொடங்கியது',
      sessionEnd: 'மதிப்பிடப்பட்ட முடிவு நேரம்',
      therapyDuration: 'அமர்வு காலம்: 45 நிமிடம்',
      back: 'திரும்பிச் செல்க',
    }
  };
  ...
  const dailyChecklist = [
    ...
    { id: 6, task: t.sleep, completed: false, time: '10:00 PM' },
  ];
  ...
  if (therapyGenerated) {
    return (
      <div className="min-h-screen bg-gray-50">
        <Navbar userRole="caregiver" language={language} />
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4">
                      ...
                      <Button
                        ...
                        className="flex-1"
                      >
                        {completedSteps.includes(currentStep) ? '✓ ' : ''}{t.complete}
                      </Button>
                      <Button
...
export default function MemoryLaneApp() {
  ...
  return (
    <div className="font-sans bg-white">
      {currentPage === 'landing' && (
        <LandingPage onSelectRole={handleSelectRole} language={language} />
      )}
